...
const HomeCars = () => {
  ...
  useEffect(() => {
    // Triggers the entrance animation 300ms after the component mounts
        ...
        {visibleCars.map((car, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Inside the visibleCars.map function */}
              <div className={styles.borderOverlay} />

              <div className={styles.priceBadge}>
                <span className={styles.priceText}>pkr{car.price}/day</span>
              </div>
