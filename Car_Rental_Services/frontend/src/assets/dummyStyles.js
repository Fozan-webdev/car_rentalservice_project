...
export const heroStyles = {
  container: "relative w-full lg:min-h-screen h-[600px]  bg-white overflow-hidden flex items-center justify-center",
  background: "absolute lg:pt-10 pt-45 inset-0 transform-gpu will-change-transform",
