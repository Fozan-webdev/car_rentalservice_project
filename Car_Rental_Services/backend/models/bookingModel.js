...
const carSummarySchema = new Schema(
  {
    ...
    category: { type: String, default: "Hatchback" }, // Mehran ke liye Hatchback default behtar hai
...
// Example export ya model definition yahan aayegi
...
// custmer details and shiping address /
